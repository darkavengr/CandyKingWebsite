#pragma checksum "C:\Users\matt\source\repos\Week17\Week17\Pages\Privacy.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "55b3debb76e93fefb00d8f69edba191da9079769"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(Week17.Pages.Pages_Privacy), @"mvc.1.0.razor-page", @"/Pages/Privacy.cshtml")]
[assembly:global::Microsoft.AspNetCore.Mvc.RazorPages.Infrastructure.RazorPageAttribute(@"/Pages/Privacy.cshtml", typeof(Week17.Pages.Pages_Privacy), null)]
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"55b3debb76e93fefb00d8f69edba191da9079769", @"/Pages/Privacy.cshtml")]
    ...
    public class Pages_Privacy : global::Microsoft.AspNetCore.Mvc.RazorPages.Page
    {
        ...
        {
#line 3 "C:\Users\matt\source\repos\Week17\Week17\Pages\Privacy.cshtml"
...
#line 6 "C:\Users\matt\source\repos\Week17\Week17\Pages\Privacy.cshtml"
Write(ViewData["Title"]);

#line default
#line hidden
            EndContext();
            BeginContext(100, 52493, true);
            WriteLiteral(@"</h1>
...
<br>
4.1	In this Section 4");
            WriteLiteral(@", we have set out the purposes for which we may process personal data and the legal bases of the processing.
<br>
...
4.3	Publications - We may process account data for the purposes of publishing such data on our website and elsewhere through our services in accordance with your express instructions. The legal basis for this processing is consent OR our legitimate interests, namely the publication of content in the ordinary course of our operations OR the performance of a ");
            WriteLiteral(@"contract between you and us and/or taking steps, at your request, to enter into such a contract OR specify basis.
<br>
...
<br>
4.5	Direct marketing - We may process contact data, account data and/or transaction data for the purposes of creating, targeting and sending direct marketing communications by email, SMS, post and/or fax and making contact by telephone for marketing");
            WriteLiteral(@"-related purposes. The legal basis for this processing is consent OR our legitimate interests, namely promoting our business and communicating marketing messages and offers to our website visitors and service users OR specify basis.
<br>
...
<br>
4.7	Record keeping - We may process your personal data for the purposes of creating and maintaining our databases, back-up copies of our databases and our business records generally. The legal basis for this processing is our legitimate interests, namely ensuring that we have access to all the information we need to properly and efficiently run o");
            WriteLiteral(@"ur business in accordance with this policy.
<br>
...
4.10	Legal claims - We may process your personal data where necessary for the establishment, exercise or defence of legal claims, whether in court proceedings or in an administrative or out-of-court procedure. The legal basis for this processing is our legitimate interests, namely the protection and assertion of our legal rights, your leg");
            WriteLiteral(@"al rights and the legal rights of others.
<br>
...
<br>
6.	International transfers of you");
            WriteLiteral(@"r personal data
<br>
...
<br>
6.2	We may transfer your personal data from the European Economic Area (EEA) to the UK and process that personal data in the UK for the purposes set out in this policy, and may permit our suppliers and subcontractors to do so, during any period with respect to which the UK is not treated as a third country under EU data protection law or benefits from an adequacy decision under EU data protection law; and we may transfer your personal data from the UK to the EEA and process that personal data in the EEA for the purposes set out in this policy, and may permit our suppliers and subcontractors to do so, during any period with respect to which EEA states are not treated as third countries under UK data protection law or benefit from adequacy regulations under ");
            WriteLiteral(@"UK data protection law.
<br>
...
<br>
6.4	Specify category or categories of supplier or subcontractor is OR are situated in specify countries. The competent data protection authorities have made an adequacy determination with respect to the data protection laws of each of these countries. Transfers to each of these countries will be protected by appropriate safeguards, namely the use of standard data protection clauses adopted or approved by the competent data protection authorities, a copy");
            WriteLiteral(@" of which can be obtained from source OR specify appropriate safeguards and means to obtain a copy.
<br>
...
<br>
(b)	account data ");
            WriteLiteral(@"will be retained for a minimum period of period following the date of closure of the relevant account, and for a maximum period of period following that date;
<br>
...
<br>
7.4	Notwithstanding the other provisions of this Section 7, we may retain your personal data where such retention is necessary for compliance with a legal obligation to which we are subject, or in order to protect your vital interests or the v");
            WriteLiteral(@"ital interests of another natural person.
<br>
8.	Your rights
<br>
...
(h)	the right to withdraw consent -");
            WriteLiteral(@" to the extent that the legal basis of our processing of your personal data is consent, you can withdraw that consent.
<br>
...
<br>
9.2	Cookies may be either ""persistent"" cookies or ""session"" cookies: a persi");
            WriteLiteral(@"stent cookie will be stored by a web browser and will remain valid until its set expiry date, unless deleted by the user before the expiry date; a session cookie, on the other hand, will expire at the end of the user session, when the web browser is closed.
<br>
...
<br>
(c)	personalisation - we use cookies to store information abo");
            WriteLiteral(@"ut your preferences and to personalise our website for you (cookies used for this purpose are: identify cookies);
<br>
...
<br>
11.1	Our service providers use cookies and those co");
            WriteLiteral(@"okies may be stored on your computer when you visit our website.
<br>
...
12.	Managing cookies
<br>
12.1	Most browsers allow you to refuse to accept cookies and to delete cookies. The methods for doing so vary from browser to browser, and from version to version. You can however obtain up-to-date information about blocking and deleting cookies via ");
            WriteLiteral(@"these links:
<br>
...
<br>
13.2	You should check this page occasionally to ensure you ar");
            WriteLiteral(@"e happy with any changes to this policy.
<br>
...
<br>
15.2	Our representative within the UK with respect to our obligations under data protection l");
            WriteLiteral(@"aw is identify representative and you can contact our representative by contact details.
<br>
...
<br>
If you collect sensitive personal information (such as information about a person's health, sexuality or political affiliations), or if you collect personal information from child");
            WriteLiteral(@"ren or about children, you should always take advice before using this (or indeed any other) privacy policy template. In any case, use of a privacy policy is only one aspect of data protection compliance.
<br>
...
<br>
Guidelines on transparency under Regulation 2016/679, European Data Protection Board - https://ec.europa.eu/newsroom/article29/item-detail.cfm");
            WriteLiteral(@"?item_id=622227
<br>
...
<br>
Sect");
            WriteLiteral(@"ion: Free documents licensing warning
<br>
...
<br>
As regards the identification of the source of personal data in the case that the personal data is not obtained from the data subject, the guidance from the European Data Protection Board ");
            WriteLiteral(@"states that:
<br>
...
Optional element.
<br>
Use this form of provision to identify other c");
            WriteLiteral(@"ategories of personal data that may be processed.
<br>
...
<br>
""Where personal data relating to a data subject are collected from the data subject, the controller shall, at the time when personal data are obtained, provide the data subject with all of the following information: ... (c) the purposes of the processing for which the personal data a");
            WriteLiteral(@"re intended as well as the legal basis for the processing; (d) where the processing is based on point (f) of Article 6(1), the legitimate interests pursued by the controller or by a third party"".
<br>
...
Article 14(2) of the GDPR, which also applies in the case that the personal data have not been obtained from the data subject, provides that:
<br>
""In addition to the information referred to in paragraph 1, the controller shall provide the data subject with the following information necessary to ensure fair and transparent processing in respect of the data subject: ... (b) where the processing is based on point (f) of Article 6(1), the legitimate interests pursued by the controller");
            WriteLiteral(@" or by a third party ... "".
<br>
...
Article 6, Regulation (EU) 2016/679 (General Data Protection Regulation) -");
            WriteLiteral(@" https://gdpr-info.eu/art-6-gdpr/
<br>
Guidelines on transparency under Regulation 2016/679, European Data Protection Board - https://ec.europa.eu/newsroom/article29/item-detail.cfm?item_id=622227
<br>
...
Article 13(1)(e) of the GDPR requires that where personal data are collected from ");
            WriteLiteral(@"the data subject, the data controller must provide the data subject with information about ""the recipients or categories of recipients of the personal data"".
<br>
...
<br>
Article 5(1)(e) of the GDPR sets out");
            WriteLiteral(@" the storage limitation, one of the fundamental rules of the regime:
<br>
...
<br>
""... the controller shall, at the time when personal data are obtained, provide the data subject with the following further information necessary to ensure fair and transparent processing: (a) the period for which th");
            WriteLiteral(@"e personal data will be stored, or if that is not possible, the criteria used to determine that period ..."".
<br>
...
<br>
""In addition to the information referred to in paragraph 1, the controller shall, at the time when personal data are obtained, provide the data subject with the following further information necessary to ensure fair a");
            WriteLiteral(@"nd transparent processing: ... (b) the existence of the right to request from the controller access to and rectification or erasure of personal data or restriction of processing concerning the data subject or to object to processing as well as the right to data portability; (c) where the processing is based on point (a) of Article 6(1) or point (a) of Article 9(2), the existence of the right to withdraw consent at any time, without affecting the lawfulness of processing based on consent before its withdrawal; ..."".
<br>
...
The European Data Protection Board guidance on this issue states:
<br>
""This information should be specific to the processing scenario and include a summary of what the right involves and how the data subject can take steps to exercise it and any limitations on the right … . In particular, the right to object to processing must be explicitly brought to the");
            WriteLiteral(@" data subject's attention at the latest at the time of first communication with the data subject and must be presented clearly and separately from any other information.""
<br>
Article 13, Regulation (EU) 2016/679 (General Data Protection Regulation) - https://gdpr-info.eu/art-13-gdpr/
<br>
Article 14, Regulation (EU) 2016/679 (General Data Protection Regulation) - https://gdpr-info.eu/art-14-gdpr/
...
<br>
""Member States shall ensure that the use of electronic communications networks to store information or to gain access to information stored in the terminal equipment of a subscriber or user is only allowed on condition that the subscriber or user concerned is provided with clear and comprehensive information in accordance with Directive 95/46/EC, inter alia about the purposes of the processing, and is offered the right to refuse such processing by the data controller. This shall not prevent any technical storage or access for the sole purpose of carrying out or facilitating the transmission of a communication over an electronic communications network, or as strictly necessary in order to ");
            WriteLiteral(@"provide an information society service explicitly requested by the subscriber or user.""
<br>
...
<br>
(3) Where an electronic communications network is used by the same person to store or access information in the terminal equipment of a subscriber or user on more than one occasion, it is sufficient for the purposes of this regulation that the requirements of paragraph (2) are met in respect of");
            WriteLiteral(@" the initial use.
<br>
...
<br>
""Where A");
            WriteLiteral(@"rticle 3(2) applies, the controller or the processor shall designate in writing a representative in the Union.""
<br>
...
<br>
""Where personal data relating to a data subject are collected from the data subject, the controller shall, at the time when personal data are obtained, provide the data subject with all of the ");
            WriteLiteral(@"following information: (a) the identity and the contact details of the controller and, where applicable, of the controller's representative"".
<br>
...
<br>
""The controller and the processor shall designate a data protection officer in any case where: (a) the processing is carried out by a public authority or body, except for courts acting in their judicial capacity; (b)");
            WriteLiteral(@" the core activities of the controller or the processor consist of processing operations which, by virtue of their nature, their scope and/or their purposes, require regular and systematic monitoring of data subjects on a large scale; or (c) the core activities of the controller or the processor consist of processing on a large scale of special categories of data pursuant to Article 9 and personal data relating to criminal convictions and offences referred to in Article 10.""
<br>
Article 13(1) of the GDPR provides that:
<br>
...
Article 37, Regulation (EU) 2016/679 (General Data Protection Regulation)");
            WriteLiteral(@" - https://gdpr-info.eu/art-37-gdpr
<br>
Article 13, Regulation (EU) 2016/679 (General Data Protection Regulation) - https://gdpr-info.eu/art-13-gdpr/
<br>
Article 14, Regulation (EU) 2016/679 (General Data Protection Regulation) - https://gdpr-info.eu/art-14-gdpr/");
